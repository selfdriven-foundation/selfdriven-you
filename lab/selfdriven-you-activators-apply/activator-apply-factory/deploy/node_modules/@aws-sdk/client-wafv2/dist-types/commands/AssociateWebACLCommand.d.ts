...
declare const AssociateWebACLCommand_base: {
    new (input: AssociateWebACLCommandInput): import("@smithy/core/client").CommandImpl<AssociateWebACLCommandInput, AssociateWebACLCommandOutput, import("..").WAFV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateWebACLCommandInput): import("@smithy/core/client").CommandImpl<AssociateWebACLCommandInput, AssociateWebACLCommandOutput, import("..").WAFV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
